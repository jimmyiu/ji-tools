...
Defines how the UpdateBanner is positioned at the bottom of the viewport as a fixed element directly above the TabBar capsule, with safe-area-aware offset and slide-up animation.
